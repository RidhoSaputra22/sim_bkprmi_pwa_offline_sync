                ...
                <ul class="menu p-4 w-full">
                    <li>
                        <a href="{{ route('tpa.dashboard') }}"
                            class="{{ request()->routeIs('tpa.dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('tpa.santri.index') }}"
                            class="{{ request()->routeIs('tpa.santri.index') || request()->routeIs('tpa.santri.show') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li class="menu-title mt-4"><span>Data Guru</span></li>

                    <li>
                        <a href="{{ route('tpa.teachers.index') }}"
                            class="{{ request()->routeIs('tpa.teachers.index') || request()->routeIs('tpa.teachers.show') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('tpa.unit.show') }}"
                            class="{{ request()->routeIs('tpa.unit.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li class="menu-title mt-4"><span>PWA & Offline</span></li>
