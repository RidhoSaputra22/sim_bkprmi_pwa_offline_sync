                ...
                <ul class="menu p-4 w-full">
                    ...
                    <li>
                        <a href="{{ route('lpptka.units.index') }}"
                            class="{{ request()->routeIs('lpptka.units.index') || request()->routeIs('lpptka.units.show') || request()->routeIs('lpptka.units.edit') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('lpptka.tpa-accounts.index') }}"
                            class="{{ request()->routeIs('lpptka.tpa-accounts.index') || request()->routeIs('lpptka.tpa-accounts.create') || request()->routeIs('lpptka.tpa-accounts.show') || request()->routeIs('lpptka.tpa-accounts.success') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('lpptka.profile') }}"
                            class="{{ request()->routeIs('lpptka.profile') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
