    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <footer class="footer footer-center p-4 bg-base-300 text-base-content">
                <aside><p>© {{ date('Y') }} BKPRMI - Admin LPPTKA</p></aside>
            </footer>
        </div>
            ...
            <aside class="bg-base-100 min-h-screen w-64 border-r border-base-300">
                <div class="p-4 border-b border-base-300">
                    <a href="{{ route('lpptka.dashboard') }}" class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center text-secondary-content font-bold">
                            LP
                        </div>
                        <div>
                ...
                <ul class="menu p-4 w-full">
                    <li>
                        <a href="{{ route('lpptka.dashboard') }}" class="{{ request()->routeIs('lpptka.dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('lpptka.units.index') }}" class="{{ request()->routeIs('lpptka.units.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('lpptka.units.create') }}" class="{{ request()->routeIs('lpptka.units.create') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('lpptka.tpa-accounts.index') }}" class="{{ request()->routeIs('lpptka.tpa-accounts.*') ? 'active' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
