...
<div class="navbar bg-base-100 border-b border-base-300 sticky top-0 z-30">
    ...
    <div class="flex flex-row-reverse gap-2">
        ...
        <div class="flex items-center gap-2">
            ...
            <!-- Pending Sync Badge -->
            <button onclick="window.syncManager?.syncAll()" class="btn btn-ghost btn-circle relative"
                ...
                <span id="offline-sync-badge"
                    class="badge badge-warning badge-xs absolute -top-1 -right-1 hidden">0</span>
            </button>
        </div>
