...
<div class="drawer-side z-40">
    ...
    <aside class="bg-base-100 min-h-screen w-64 border-r border-base-300">
        ...
        <ul class="menu p-4 w-full">
            ...
            <!-- Kelola Arsip -->
            <li>
                <a href="{{ route('admin.archives.index') }}" class="{{ request()->routeIs('admin.archives.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Validasi Data -->
            <li>
                <a href="{{ route('admin.validation.index') }}" class="{{ request()->routeIs('admin.validation.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
