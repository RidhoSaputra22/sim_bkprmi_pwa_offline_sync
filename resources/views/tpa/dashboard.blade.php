<x-layouts.tpa title="Dashboard Admin TPA">
    ...
    <div class="mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('tpa.santri.create') }}" class="card bg-primary text-primary-content shadow hover:shadow-lg transition-shadow">
            ...
            <a href="{{ route('tpa.santri.index') }}" class="card bg-secondary text-secondary-content shadow hover:shadow-lg transition-shadow">
                <div class="card-body items-center text-center">
                    <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('tpa.unit.show') }}" class="card bg-accent text-accent-content shadow hover:shadow-lg transition-shadow">
                <div class="card-body items-center text-center">
                    <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
