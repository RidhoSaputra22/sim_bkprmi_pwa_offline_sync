<x-layouts.tpa title="Edit Santri - {{ $santri->person?->full_name }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <input type="text" name="full_name"
                                value="{{ old('full_name', $santri->person?->full_name) }}"
                        ...
                        <div class="form-control">
                            ...
                            <select name="gender" class="select select-bordered @error('gender') select-error @enderror"
                                ...
                                <option value="{{ $gender->value }}"
                                    {{ old('gender', $santri->person?->gender?->value) == $gender->value ? 'selected' : '' }}>
                                    {{ $gender->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="child_order"
                                value="{{ old('child_order', $santri->child_order) }}" min="1"
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="siblings_count"
                                value="{{ old('siblings_count', $santri->siblings_count) }}" min="0"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <select name="jenjang_santri"
                                ...
                                <option value="{{ $jenjang->value }}"
                                    {{ old('jenjang_santri', $santri->jenjang_santri?->value) == $jenjang->value ? 'selected' : '' }}>
                                    {{ $jenjang->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <select name="kelas_mengaji"
                                ...
                                <option value="{{ $kelas->value }}"
                                    {{ old('kelas_mengaji', $santri->kelas_mengaji?->value) == $kelas->value ? 'selected' : '' }}>
                                    {{ $kelas->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <select name="status_santri"
                                ...
                                <option value="{{ $status->value }}"
                                    {{ old('status_santri', $santri->status_santri?->value) == $status->value ? 'selected' : '' }}>
                                    {{ $status->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <input type="date" name="joined_at"
                                value="{{ old('joined_at', $santri->santriUnits?->firstWhere('unit_id', $unit->id)?->joined_at?->format('Y-m-d')) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            ...
                            <select name="district_id" x-model="districtId" @change="loadVillages()"
                                ...
                                <option value="{{ $district->id }}"
                                    {{ old('district_id', $santri->village?->district_id) == $district->id ? 'selected' : '' }}>
                                    {{ $district->name }}
                                </option>
                                @endforeach
                            </select>
                            ...
                            <select name="village_id" x-model="villageId"
                                ...
                                <template x-for="village in villages" :key="village.id">
                                    <option :value="village.id" x-text="village.name"
                                        :selected="village.id == initialVillageId"></option>
                                </template>
                            </select>
                            @error('village_id')
                            <label class="label"><span class="label-text-alt text-error">{{ $message }}</span></label>
                        ...
                        <div class="form-control md:col-span-2">
                            ...
                            <textarea name="address"
                                ...
                                placeholder="Jalan, dll">{{ old('address', $santri->address) }}</textarea>
                            @error('address')
                            <label class="label"><span class="label-text-alt text-error">{{ $message }}</span></label>
                            @enderror
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="rt" value="{{ old('rt', $santri->rt) }}"
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="rw" value="{{ old('rw', $santri->rw) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-control">
                            <label class="label"><span class="label-text">Nama Wali <span
                                        class="text-error">*</span></span></label>
                            <input type="text" name="wali_full_name"
                                value="{{ old('wali_full_name', $guardianSantri?->guardian?->person?->full_name) }}"
                        ...
                        <div class="form-control">
                            ...
                            <select name="wali_gender"
                                ...
                                @foreach(\App\Enum\Gender::cases() as $gender)
                                <option value="{{ $gender->value }}"
                                    {{ old('wali_gender', $guardianSantri?->guardian?->person?->gender?->value) == $gender->value ? 'selected' : '' }}>
                                    {{ $gender->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <select name="wali_hubungan"
                                ...
                                <option value="{{ $hubungan->value }}"
                                    {{ old('wali_hubungan', $guardianSantri?->hubungan?->value) == $hubungan->value ? 'selected' : '' }}>
                                    {{ $hubungan->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="wali_nik"
                                value="{{ old('wali_nik', $guardianSantri?->guardian?->person?->nik) }}"
                        ...
                        <div class="form-control">
                            <label class="label"><span class="label-text">No. HP Wali</span></label>
                            <input type="text" name="wali_phone"
                                value="{{ old('wali_phone', $guardianSantri?->guardian?->person?->phone) }}"
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="wali_birth_place"
                                value="{{ old('wali_birth_place', $guardianSantri?->guardian?->person?->birth_place) }}"
                        ...
                        <div class="form-control">
                            ...
                            <input type="date" name="wali_birth_date"
                                value="{{ old('wali_birth_date', $guardianSantri?->guardian?->person?->birth_date?->format('Y-m-d')) }}"
                        ...
                        <x-ui.multi-select
                            ...
                            :selected="old('wali_pekerjaan', $guardianSantri?->guardian?->pekerjaan ?? [])"
                        ...
                        <div class="form-control">
                            ...
                            <select name="wali_pendidikan"
                                ...
                                <option value="{{ $pendidikan->value }}"
                                    {{ old('wali_pendidikan', $guardianSantri?->guardian?->pendidikan_terakhir?->value) == $pendidikan->value ? 'selected' : '' }}>
                                    {{ $pendidikan->getLabel() }}
                                </option>
                                @endforeach
                            </select>
    ...
    function santriForm() {
        return {
            districtId: "{{ old('district_id', $santri->village?->district_id) }}",
            villageId: "{{ old('village_id', $santri->village_id) }}",
            initialVillageId: "{{ old('village_id', $santri->village_id) }}",
            villages: [],
