        ...
        <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <select name="tipe_lokasi" class="select select-bordered @error('tipe_lokasi') select-error @enderror">
                                ...
                                <option value="{{ $tipe->value }}" {{ old('tipe_lokasi') == $tipe->value ? 'selected' : '' }}>
                                    {{ $tipe->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <select name="status_bangunan" class="select select-bordered @error('status_bangunan') select-error @enderror">
                                ...
                                <option value="{{ $status->value }}" {{ old('status_bangunan') == $status->value ? 'selected' : '' }}>
                                    {{ $status->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            ...
                            <select name="waktu_kegiatan" class="select select-bordered @error('waktu_kegiatan') select-error @enderror">
                                ...
                                <option value="{{ $waktu->value }}" {{ old('waktu_kegiatan') == $waktu->value ? 'selected' : '' }}>
                                    {{ $waktu->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <select name="head_gender" class="select select-bordered @error('head_gender') select-error @enderror">
                                ...
                                <option value="{{ $gender->value }}" {{ old('head_gender') == $gender->value ? 'selected' : '' }}>
                                    {{ $gender->getLabel() }}
                                </option>
                                @endforeach
                            </select>
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    <div class="form-control">
                        <label class="label"><span class="label-text">File Sertifikat (PDF/JPG/PNG, max 2MB)</span></label>
