<x-layouts.lpptka title="Daftar Unit TPA Baru">
    ...
    <form action="{{ route('lpptka.units.store') }}" method="POST" enctype="multipart/form-data" x-data="unitForm({
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            <label class="label"><span class="label-text">Tipe Lokasi <span
                                        class="text-error">*</span></span></label>
                            <select name="tipe_lokasi"
                                class="select select-bordered @error('tipe_lokasi') select-error @enderror" required>
                                <option value="">-- Pilih Tipe --</option>
                                @foreach(\App\Enum\TipeLokasi::cases() as $tipe)
                                <option value="{{ $tipe->value }}"
                                    {{ old('tipe_lokasi') == $tipe->value ? 'selected' : '' }}>
                                    {{ $tipe->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            <label class="label"><span class="label-text">Status Bangunan <span
                                        class="text-error">*</span></span></label>
                            <select name="status_bangunan"
                                ...
                                <option value="{{ $status->value }}"
                                    {{ old('status_bangunan') == $status->value ? 'selected' : '' }}>
                                    {{ $status->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control">
                            <label class="label"><span class="label-text">Waktu Kegiatan <span
                                        class="text-error">*</span></span></label>
                            <select name="waktu_kegiatan"
                                class="select select-bordered @error('waktu_kegiatan') select-error @enderror" required>
                                <option value="">-- Pilih Waktu --</option>
                                @foreach(\App\Enum\WaktuKegiatan::cases() as $waktu)
                                <option value="{{ $waktu->value }}"
                                    {{ old('waktu_kegiatan') == $waktu->value ? 'selected' : '' }}>
                                    {{ $waktu->getLabel() }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control">
                            ...
                            <select name="head_gender"
                                class="select select-bordered @error('head_gender') select-error @enderror" required>
                                <option value="">-- Pilih --</option>
                                @foreach(\App\Enum\Gender::cases() as $gender)
                                <option value="{{ $gender->value }}"
                                    {{ old('head_gender') == $gender->value ? 'selected' : '' }}>
                                    {{ $gender->getLabel() }}
                                </option>
                                @endforeach
                            </select>
