        ...
        <div class="space-y-6">
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    @if($unit->isRejected())
                    <div class="mt-4">
                        <form action="{{ route('lpptka.units.resubmit', $unit) }}" method="POST"
                            onsubmit="return confirm('Apakah Anda yakin ingin mengajukan ulang unit ini?')">
                            @csrf
                        ...
                        <p class="text-xs text-base-content/60 mt-2 text-center">
                            Ajukan ulang untuk direview kembali oleh SuperAdmin
                        </p>
                    </div>
                    @endif
                </div>
