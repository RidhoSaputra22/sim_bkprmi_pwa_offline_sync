<x-layouts.lpptka title="Detail Unit - {{ $unit->name }}">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    <h2 class="card-title">Statistik Santri</h2>
                    <div class="grid grid-cols-3 gap-4 mt-4">
                        <div class="stat bg-base-200 rounded-lg">
                            <div class="stat-title">Total Santri</div>
                            <div class="stat-value text-primary">{{ $unit->santris_count ?? 0 }}</div>
                        </div>
                        <div class="stat bg-base-200 rounded-lg">
                            <div class="stat-title">Santri Aktif</div>
                            <div class="stat-value text-success">{{ $unit->active_santris_count ?? 0 }}</div>
                        </div>
                        <div class="stat bg-base-200 rounded-lg">
                            <div class="stat-title">Guru/Pengajar</div>
                            <div class="stat-value text-info">{{ $unit->teachers_count ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-base-100 shadow">
                <div class="card-body">
                    ...
                    <div class="text-center py-4">
                        ...
                        <form action="{{ route('lpptka.units.upload-certificate', $unit) }}" method="POST" enctype="multipart/form-data" class="mt-4">
                            @csrf
                            <div class="form-control">
                                <input type="file" name="certificate" accept=".pdf,.jpg,.jpeg,.png" class="file-input file-input-bordered file-input-sm w-full" required>
                            </div>
