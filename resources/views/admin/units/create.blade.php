                            ...
                            @foreach($tipeLokasiOptions as $tipe)
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        {{ old('tipe_lokasi') == $tipe->value ? 'checked' : '' }}
                                        required
                                    />
                            ...
                            @foreach($statusBangunanOptions as $status)
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        value="{{ $status->value }}"
                                        class="radio radio-primary"
                                        {{ old('status_bangunan') == $status->value ? 'checked' : '' }}
                                        required
                                    />
                            ...
                            @foreach($waktuKegiatanOptions as $waktu)
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        value="{{ $waktu->value }}"
                                        class="radio radio-primary"
                                        {{ old('waktu_kegiatan') == $waktu->value ? 'checked' : '' }}
                                        required
                                    />
        ...
        <x-ui.card title="PENANGGUNG JAWAB UNIT" subtitle="Data kepala unit TPA/TPQ">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @foreach($genderOptions as $gender)
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    value="{{ $gender->value }}"
                                    class="radio radio-primary"
                                    {{ old('kepala_gender') == $gender->value ? 'checked' : '' }}
                                    required
                                />
                ...
                <x-ui.select
                    ...
                    :required="true"
                    :selected="old('kepala_pendidikan')"
                />
