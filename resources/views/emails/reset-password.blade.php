    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="warning-box">
                ...
                <p>Jika Anda tidak meminta reset password, abaikan email ini. Akun Anda tetap aman dan tidak ada perubahan yang dilakukan.</p>
            </div>

            <div class="message">
                Untuk keamanan akun Anda, jangan bagikan link ini kepada siapapun. Tim BKPRMI tidak akan pernah meminta password Anda melalui email atau media lainnya.
            </div>
        </div>
