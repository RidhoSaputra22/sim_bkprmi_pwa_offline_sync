            ...
            <div class="card-body">
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <div>
                        ...
                        <progress class="progress progress-primary w-full" value="{{ $jenjangStats['tka'] ?? 0 }}" max="{{ $totalJenjang }}"></progress>
                    </div>
                    ...
                    <div>
                        ...
                        <progress class="progress progress-secondary w-full" value="{{ $jenjangStats['tpa'] ?? 0 }}" max="{{ $totalJenjang }}"></progress>
                    </div>
                    ...
                    <div>
                        ...
                        <progress class="progress progress-accent w-full" value="{{ $jenjangStats['tqa'] ?? 0 }}" max="{{ $totalJenjang }}"></progress>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="flex justify-center items-center gap-8 py-6">
                    ...
                    <div class="text-center">
                        <div class="radial-progress text-info" style="--value:{{ $malePercent }}; --size:8rem;" role="progressbar">
                    ...
                    <div class="text-center">
                        <div class="radial-progress text-secondary" style="--value:{{ $femalePercent }}; --size:8rem;" role="progressbar">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right font-bold text-warning">{{ number_format($stats['pending_units'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="flex items-center gap-2">
                                ...
                                <td class="text-right font-bold text-success">{{ number_format($stats['approved_units'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="flex items-center gap-2">
                                ...
                                <td class="text-right font-bold text-error">{{ number_format($stats['rejected_units'] ?? 0) }}</td>
                            </tr>
                            <tr class="border-t-2">
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right font-bold text-success">{{ number_format($stats['by_status']['aktif'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="flex items-center gap-2">
                                ...
                                <td class="text-right font-bold text-warning">{{ number_format($stats['by_status']['lulus_wisuda'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="flex items-center gap-2">
                                ...
                                <td class="text-right font-bold text-info">{{ number_format($stats['by_status']['lanjut_tqa'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="flex items-center gap-2">
                                ...
                                <td class="text-right font-bold text-secondary">{{ number_format($stats['by_status']['pindah'] ?? 0) }}</td>
                            </tr>
                            <tr>
                                <td>
                                    <span class="flex items-center gap-2">
                                ...
                                <td class="text-right font-bold text-error">{{ number_format($stats['by_status']['berhenti'] ?? 0) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="card bg-base-100 shadow">
        <div class="card-body">
            ...
            <div class="alert alert-info mt-4">
                ...
                <span>Fitur export laporan akan tersedia dalam update selanjutnya.</span>
            </div>
